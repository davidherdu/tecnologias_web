	...
	<div id="wrapper">
		<div id="header-wrapper-publicas">
			<div id="header">
				<div id="menu-wrapper" style="width: relative;">
					<ul id="menu">
						...
						<li class="current_page_item"><a href="publicas.php"><span>Fotos Publicas</span></a></li>
									...
									<form id="loginForm"action="login.php" method="post">
										<fieldset id="body">
											...
											<fieldset>
												...
												<input type="password" name="password" id="password" class=":required" title="Introduce la contrase&ntilde;a"/>
											</fieldset>
			...
			<div id="logo">
				...
				<p style="margin-top: 12px;">Fotos publicas</p>
			</div>
		</div>		
		<!-- end #menu -->
			<!-- start -->
						...
						<div class="visor">
							<div class="gira">
								<div id="gallery">
									<div class="imagen">
										<ul>
											<li class="nopad"><a href="images/india1.jpg"><img src="images/india1.jpg" width="230" height="150" alt="" /></a></li>
											<li><a href="images/india2.jpg"><img src="images/india2.jpg" width="230" height="150" alt="" /></a></li>
											<li><a href="images/india3.jpg"><img src="images/india3.jpg" width="230" height="150" alt=""  /></a></li>
											<li class="nopad"><a href="images/india4.jpg"><img src="images/india4.jpg" width="230" height="150" alt=""  /></a></li>
											<li><a href="images/india5.jpg"><img src="images/india5.jpg" width="230" height="150" alt=""  /></a></li>
									...
									<div class="imagen">
										<ul>
											<li class="nopad"><a href="images/pic01-big.jpg"><img src="images/pic01-big.jpg" width="230" height="150" alt="" /></a></li>
											<li><a href="images/pic02-big.jpg"><img src="images/pic02-big.jpg" width="230" height="150" alt="" /></a></li>
											<li><a href="images/pic03-big.jpg"><img src="images/pic03-big.jpg" width="230" height="150" alt=""  /></a></li>
											<li class="nopad"><a href="images/londres1.jpg"><img src="images/londres1.jpg" width="230" height="150" alt=""  /></a></li>
											<li><a href="images/londres2.jpg"><img src="images/londres2.jpg" width="230" height="150" alt=""  /></a></li>
											<li><a href="images/londres3.jpg"><img src="images/londres3.jpg" width="230" height="150" alt=""  /></a></li>
											<li class="nopad"><a href="images/india3.jpg"><img src="images/india3.jpg" width="230" height="150" /></a></li>
