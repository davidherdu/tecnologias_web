	...
	<div id="wrapper">
		<div id="header-wrapper-publicas">
			...
			<div id="logo">
				...
				<ul>
					<li style="margin:15px 15px 30px 125px; "><a href="#"><p>Albumes de Juan</p></a></li>
					<li><a href="#"><p>Lista de amigos de Juan</p></a></li>
					<li><a href="#"><p>Grupos en comun</p></a></li>
				</ul>
				<div style="clear: both;">&nbsp;</div>
			</div>
		</div>		
					...
					<div class="visor">
						<div class="gira">
							<div id="gallery">
								<div class="imagen">
									<ul>
										<li class="nopad"><a href="foto.php"><img src="images/india1.jpg" width="230" height="150" alt="" /></a></li>
